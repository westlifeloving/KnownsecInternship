      ...
      <el-header>
        ...
        >
          ...
          <el-submenu class="userinfor" index="6">
            <template slot="title" class="admin">{{ sname }}</template>
        ...
        >
          ...
          <el-table-column prop="operation" label="操作">
            <template slot-scope="scope">
              <el-button @click="goPushColumn('edit');handleEdit(scope.$index, tableData)" type="text" size="small"
                >修改</el-button
              >
              <el-button
